    ...
    <main className="auth-page">
      ...
      <section className="auth-card anim-auth-card">
        ...
        <div className="auth-brand anim-auth-logo">
          ...
          <div>
            <h1 className="auth-brand-title">DynamiTeam</h1>
        ...
        <div className="auth-heading">
          <h2>
            <span>Welcome Back,</span> DynamiTeam
          </h2>
          <p>
            Login untuk mengakses activity, nyawa, leaderboard, dan profil squad
          </p>
        </div>
